...
- **include_market_cap** (boolean): Whether to include market cap data (default: false)
- **include_24hr_vol** (boolean): Whether to include 24h volume data (default: false)
- **include_24hr_change** (boolean): Whether to include 24h price change data (default: false)
- **include_last_updated_at** (boolean): Whether to include last update timestamp (default: false)
