...
- **vs_currency** (string, optional): The target currency to display prices in (e.g., "usd", "eur") - defaults to "usd"
- **duration** (string, optional): Time range for price changes - one of "24h", "7d", "14d", "30d", "60d", "1y" - defaults to "24h"
- **top_coins** (string, optional): Filter by market cap ranking (e.g., "100", "1000") - defaults to "1000"
